...
namespace ETAPU11Lib.Models
{
    ...
    public class ETAPU11Data
    {
        ...
        public uint[] DataBlock2
        {
            ...
            set
            {
                if (value.Length == 38)
                {
                    ...
                    HeatingHolidayStart = GetDateTimeOffsetValue(value[22]);
                    HeatingHolidayEnd = GetDateTimeOffsetValue(value[23]);
                    // Storage
        ...
        /// <summary>
        /// Updates the Properties used in overview data.
        /// </summary>
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public DateTimeOffset GetDateTimeOffsetValue(uint value)
        {
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public uint GetUInt32Value(DateTimeOffset value)
        {
        ...
        public static EtaAttribute GetEtaAttribute(string property) =>
                EtaAttribute.GetEtaAttribute(typeof(ETAPU11Data).GetProperty(property));
        ...
        public static ModbusAttribute GetModbusAttribute(string property) =>
                ModbusAttribute.GetModbusAttribute(typeof(ETAPU11Data).GetProperty(property));
