    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // Add the gateway and ping settings.
                ...
                .AddSingleton<IHeliosSettings>(settings.GatewaySettings)
            ...
            services
                ...
                .AddHealthChecks()
                    ...
                    .AddCheck<GatewayHealthCheck<HeliosGateway>>("gateway1", tags: new[] { "gateway" })
        ...
        {
            app.ApplicationServices.GetRequiredService<HeliosGateway>().Startup();
