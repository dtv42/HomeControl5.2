...
namespace ModbusRTU.Controllers
{
    ...
    public class InputRegistersController : ModbusController
    {
        ...
        public InputRegistersController(IRtuModbusClient client, IConfiguration configuration, ILogger<CoilController> logger)
            : base(client, configuration, logger)
        {
            _logger.LogDebug("InputRegistersController()");
        }
