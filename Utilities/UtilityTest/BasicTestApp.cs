namespace UtilityTest
{
    ...
    public class BasicTestApp
    {
        ...
        [InlineData("validate -v 42 -o",                     "O Integer Value: 0",                                         ExitCodes.SuccessfullyCompleted)]
        ...
        [InlineData("validate -v 42 -b 10",                  "B Integer Value: 10",                                        ExitCodes.SuccessfullyCompleted)]
        [InlineData("validate -v 42 -i 10",                  "I Integer Value: 10",                                        ExitCodes.SuccessfullyCompleted)]
        ...
        [InlineData("validate -v 42 -c X",                   "C Character Value: X",                                       ExitCodes.SuccessfullyCompleted)]
        ...
        [InlineData("validate -v 42 -b 256",                 "Cannot parse argument '256' for option '-b'",                ExitCodes.IncorrectFunction)]
        [InlineData("validate -v 42 -i 65536",               "Cannot parse argument '65536' for option '-i'",              ExitCodes.IncorrectFunction)]
        ...
        [InlineData("validate -v 42 -f X",                   "Argument 'X' not recognized. Must be one of:",               ExitCodes.IncorrectFunction)]
